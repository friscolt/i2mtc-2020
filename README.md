...
* `data.mat` - MAT file. It contains a cell with two fields. 
  * Field 1 contains a package of 30 *in-vitro* speckle images of a straight vessel at a depth of $0\mu m$. The image is a $445\times461\times30$ grayscale matrix.
  * Field 2 contains the ground truth of the *in-vitro* speckle image of a straight vessel. The image is a $445\times461$ pixel logical type matrix. 
